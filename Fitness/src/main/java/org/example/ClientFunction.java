...
public class ClientFunction {
    ...
    private void editPersonalDetails(String clientId) throws IOException {
        ...
        updateFile("C:\\path\\to\\clients.txt", clientDetails, clientId);
    ...
    private void trackProgress(String clientId) throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\path\\to\\progress.txt"))) {
            String line;
    ...
    private void giveFeedback(String clientId) throws IOException {
        ...
        appendToFile("C:\\path\\to\\feedback.txt", feedbackData);
